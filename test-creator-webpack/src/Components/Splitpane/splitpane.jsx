                                ...
                                > */}
                                    ...
                                    <div id="ppal-screen" style={{width: "100%", height:"100%", backgroundColor: this.state.isToggled ? white : black2, }}>
                                        ...
                                        <SplitterLayout primaryIndex={0} percentage secondaryInitialSize={50} customClassName="main-separator"
                                                onSecondaryPaneSizeChange={this.onSecondaryPaneSizeChange}
                                        >    
                                            <div style={{paddingTop: 45, width: '100%', overflowY: 'hidden',}}><DetailedExpansionPanel monacoCode={this.onCodeChange} /></div>
                                            <div style={{height: '100%', overflowY: 'hidden', paddingTop: 45}}><MonacoEditor codeMonaco={this.state.codeMonaco} /></div>
                                        </SplitterLayout>   
                                            {/* } */}
                                        </div>
