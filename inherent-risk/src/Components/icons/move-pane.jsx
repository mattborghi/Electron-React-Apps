...
function MovePaneLogo({ className, fill }) {
  return (
    <SvgIcon viewBox="0 0 520 520" className={className}>
    <g><path fill={fill} d="M78.018,178.588h143.91l53.586,54.054h-102.96l97.345,97.812l-39.547,39.78l-98.514-97.578v103.662l-53.82-53.82V178.588z    
